...
const darkColors: ColorOverride = [
  '#efeef6',
  '#b0abcd',
  '#9089bc',
  '#7267aa',
...
export const MantineUIThemeProvider = (props: MantineUIThemeProviderProps) => {
  ...
  const [overrides, setOverrides] = useState<
    Record<string, MantineThemeOverride>
  >({});
