...
export const useNotify = () => {
  ...
  const messageText = (
    ...
    if (typeof message === 'string') {
      ...
      if (type === 'loading' && wrappers.loading)
        return wrappers.loading(message);
      if (type === 'success' && wrappers.success)
        return wrappers.success(message);

      return <>{fixedMessage(message)}</>;
    }
